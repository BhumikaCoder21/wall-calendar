    ...
    >
      <div className="relative w-full max-w-5xl mx-auto px-3 py-8 md:py-12">
        <div className="flex justify-center">
          <div
            className={clsx("w-px h-8", isDark ? "bg-ink-600" : "bg-ink-300")}
          />
        </div>
        ...
        >
          ...
          >
            <div className="flex flex-col lg:flex-row">
              <div
                className={clsx(
                  "flex-1 flex flex-col border-b lg:border-b-0 lg:border-r",
                  divider,
                )}
              >
                <CalendarHeader
              ...
              <div
                className="w-full lg:w-72 xl:w-80 flex-shrink-0 flex flex-col"
                style={{ minHeight: 400 }}
              >
                <NotesPanel
                  currentDate={cal.currentDate}
